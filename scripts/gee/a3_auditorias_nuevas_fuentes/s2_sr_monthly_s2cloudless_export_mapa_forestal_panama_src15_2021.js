// ============================================================
// PGBM - Auditoría espectral nuevas fuentes
// Extracción espectro-temporal Sentinel-2 SR mensual a 20 m
// Caso: MIAMBIENTE - Cultivos Mapa Panamá 2021
// Fuente: SRC15
//
...
// src/actividad_3/a3_auditorias_nuevas_fuentes/caso_panama/
// 03_s2_sr_gee_input_mapa_forestal_panama.py
//
// Unidad de extracción:
// Longitud + Latitud + Año
//
// CSV esperado:
// s2sr_units_PAN_2021_SRC15_batch_001.csv
//
...
var DRIVE_FOLDER = 'PGBM_S2SR_monthly_s2cloudless_mapa_forestal_panama_src15_2021';
...
var BATCHES_TO_EXPORT = [
  {
    name: 's2sr_units_PAN_2021_SRC15_batch_001',
    tableObj: table,
    run: true
  }
];
...
// Propiedades compatibles con el CSV generado para Panamá SRC15 2021.
var pointProperties = [
  'extract_id',
  'lon_out',
  'lat_out',
...
function preparePoints(pointsRaw) {
  var points = ee.FeatureCollection(pointsRaw).map(function(f) {
    // Usamos lon/lat del batch CSV como geometría explícita.
...
batchesToRun.forEach(function(batch, i) {
  ...
  var outputName = 'pgbm_s2sr_monthly_s2cloudless_mapa_forestal_panama_src15_2021_' + cleanBatchName;
