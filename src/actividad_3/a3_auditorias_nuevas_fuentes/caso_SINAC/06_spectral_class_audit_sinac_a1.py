...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Auditoría espectral SINAC con metodología A1.")
...
def main() -> None:
    ...
    print("============================================================")
    print("PGBM - Auditoría espectral A1 - caso SINAC")
    print("============================================================")
    ...
    report = "\n".join(
        [
            "# Auditoría espectral A1 - caso SINAC",
            "",
