# -*- coding: utf-8 -*-
"""Wrapper GPU para validar insumos XGBoost con salidas separadas."""
...
CPU_SCRIPT = REPO_ROOT / "src" / "actividad_4" / "XGBoost" / "4_9_1_validate_xgboost_inputs.py"
DEFAULT_CONFIG = REPO_ROOT / "config" / "a4_9_xgboost_gpu.yaml"
CONFIG_SECTION = "validate_inputs"


def load_cpu_module():
    spec = importlib.util.spec_from_file_location("a4_9_1_validate_xgboost_inputs", CPU_SCRIPT)
